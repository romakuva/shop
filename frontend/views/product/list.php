            ...
            <div id="products-list">
                <ul>
                    ...
                    <li>
                        ...
                        <a href="http://alif.io/frontend/index.php?model=product&action=view&id=<?=$all[ $i ] ['id']?>"><img src="http://alif.io/uploads/products/<?=$all[ $i ] ['picture']?>"></a>
                        <h4><a href="http://alif.io/frontend/index.php?model=product&action=view&id=<?=$all[ $i ] ['id']?>"><?=$all[ $i ] ['title']?></a></h4>
