...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card card-info">
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" action="http://alif.io/backend/index.php?model=product&action=save" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <?php
                            if (!empty($one['picture'])) {
                                ?>
                                <img src="http://alif.io/uploads/products/<?php echo $one['picture'];?>"style="width: 70px;">
                                <?php
                            }
                        ?>
                    </div>
